    ...
    while (true)  {
      ...
      if (Serial1.available()) {
        ...
        switch (c)  {
          //값으로 'r'이 들어올 경우
          case 'r' :
            analogWrite(redPin, Serial1.parseInt());  //redPin 색 변화
            break;
          //값으로 'g'이 들어올 경우
          case 'g' :
            analogWrite(greenPin, Serial1.parseInt());//greenPin 색 변화
            break;
          //값으로 'b'이 들어올 경우
          case 'b' :
            analogWrite(bluePin, Serial1.parseInt());//bluePin 색 변화
            break;
          //값으로 'q'이 들어올 경우
          case 'q' :
            setColor(0, 0, 0);    //LED 초기화
            mode = 0;             //모드 초기화
            break;
        }
      }
